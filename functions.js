...
function showMessageLogin(message) { return resultDivLogin.innerHTML = message; }
function showMessageReg(message) { resultDivReg.innerHTML = message; }


function cleanDiv() { resultDiv.innerHTML = ""; }
function cleanDivGeneric(divId) { document.getElementById(divId).innerHTML = ""; }
